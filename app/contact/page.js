      ...
      <section className="container mx-auto px-4 py-14 max-w-4xl">
        <div className="grid md:grid-cols-3 gap-8">
          <div className="space-y-6">
            <div>
              <div className="w-10 h-10 rounded-xl bg-primary grid place-items-center text-white mb-2"><Phone className="w-5 h-5" /></div>
              <div className="font-semibold text-foreground">Call Us</div>
              <div className="text-sm text-muted-foreground">913516880</div>
            </div>
            <div>
              <div className="w-10 h-10 rounded-xl bg-primary grid place-items-center text-white mb-2"><Mail className="w-5 h-5" /></div>
              <div className="font-semibold text-foreground">Email Us</div>
              <div className="text-sm text-muted-foreground">search2service@gmail.com</div>
            </div>
            <div>
              <div className="w-10 h-10 rounded-xl bg-primary grid place-items-center text-white mb-2"><MapPin className="w-5 h-5" /></div>
              <div className="font-semibold text-foreground">Head Office</div>
              <div className="text-sm text-muted-foreground">Shivpuri, Ramchandrapur, Biharsharif, Nalanda-803101</div>
            </div>
          </div>
