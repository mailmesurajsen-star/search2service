  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="container mx-auto px-4 py-14 max-w-4xl space-y-10">
        <div>
          <h2 className="text-xl font-bold mb-2 flex items-center gap-2"><Newspaper className="w-5 h-5 text-indigo-600" /> About Search2Service</h2>
        ...
        <div>
          <h2 className="text-xl font-bold mb-3 flex items-center gap-2"><ImageIcon className="w-5 h-5 text-indigo-600" /> Brand Assets</h2>
        ...
        <div>
          <h2 className="text-xl font-bold mb-2 flex items-center gap-2"><Mail className="w-5 h-5 text-indigo-600" /> Media Contact</h2>
          <p className="text-slate-600 leading-relaxed">
            For interviews, quotes, or partnership announcements, please write to us at{' '}
            <a href="mailto:press@search2service.in" className="text-indigo-600 font-semibold hover:underline">press@search2service.in</a>.
