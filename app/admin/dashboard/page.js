...
import {
  ...
  Target, BarChart3, Layers3, Landmark, CreditCard, Wallet, KeyRound, IndianRupee, Crown
} from 'lucide-react';
...
const GRADIENT_PRESETS = [
  { label: 'Brand (Blue to Orange)', value: 'from-blue-950/90 via-blue-900/85 to-orange-800/80', bg: 'bg-gradient-to-r from-blue-900 to-orange-600' },
  { label: 'Healthcare Cyan', value: 'from-slate-950/90 via-blue-950/85 to-cyan-950/80', bg: 'bg-gradient-to-r from-slate-900 via-blue-900 to-cyan-700' },
  { label: 'Warm Amber', value: 'from-slate-950/90 via-amber-950/85 to-orange-950/80', bg: 'bg-gradient-to-r from-slate-900 via-amber-800 to-orange-700' },
  { label: 'Deep Indigo', value: 'from-slate-950/90 via-indigo-950/85 to-blue-900/80', bg: 'bg-gradient-to-r from-slate-950 via-indigo-900 to-blue-800' },
  { label: 'Purple Velvet', value: 'from-indigo-950/90 via-purple-950/85 to-slate-950/80', bg: 'bg-gradient-to-r from-indigo-900 via-purple-900 to-slate-900' },
  { label: 'Emerald Teal', value: 'from-slate-950/90 via-emerald-950/85 to-teal-950/80', bg: 'bg-gradient-to-r from-slate-950 via-emerald-900 to-teal-800' },
];

const PLACEMENT_OPTIONS = [
  { value: 'homepage_banner', label: '🏠 Homepage Middle Banner', desc: 'Prominent wide banner displayed between homepage sections', badgeColor: 'bg-purple-950 text-purple-300 border-purple-800' },
  ...
  { value: 'search_sidebar', label: '📑 Search & Category Sidebar', desc: 'Vertical card banner in the search and category filters sidebar', badgeColor: 'bg-blue-950 text-blue-300 border-blue-800' },
  { value: 'popup_modal', label: '💬 Floating Promo Toast / Modal', desc: 'Bottom-right floating promotional card with dismiss button', badgeColor: 'bg-rose-950 text-rose-300 border-rose-800' },
  ...
  if (loading || !user) {
    return (
      <div className="min-h-screen bg-slate-900 flex flex-col items-center justify-center text-white">
        ...
        <div className="text-slate-400">Loading Search2Service Admin Console...</div>
      </div>
    );
  }

  const overviewTiles = [
    { icon: Users, label: 'Customers', value: stats.customers || 0, color: 'from-blue-500 to-indigo-700', tab: 'users' },
    { icon: Building2, label: 'Providers', value: stats.providers || 0, color: 'from-orange-500 to-red-600', tab: 'providers' },
    { icon: Megaphone, label: 'Live Ads & Banners', value: adsStats.activeAds || 0, color: 'from-amber-500 via-orange-500 to-rose-600', tab: 'ads' },
    { icon: Stethoscope, label: 'Doctors & Clinics', value: stats.doctors || 0, color: 'from-rose-500 to-pink-600', tab: 'providers' },
    { icon: Layers, label: 'Categories', value: stats.categories || 0, color: 'from-emerald-500 to-teal-700', tab: 'categories' },
    { icon: Calendar, label: 'Bookings', value: stats.bookings || 0, color: 'from-purple-500 to-indigo-800', tab: 'bookings' },
  ];

  const mgmtModules = [
    { id: 'ads', icon: Megaphone, title: 'Ads & Banners Manager', desc: 'Create, schedule, target placements & track banner analytics', color: 'from-amber-500 via-orange-500 to-rose-600', count: `${adsStats.totalAds || 0} campaigns` },
    { id: 'hero-slider', icon: Sparkles, title: 'Hero Section Slider', desc: 'Create, reorder & customize homepage rotating banners', color: 'from-blue-600 via-indigo-600 to-orange-500', count: `${heroSlides.length || 0} slides` },
    { id: 'providers', icon: Building2, title: 'Provider Management', desc: 'Approve, verify, edit, or feature service providers', color: 'from-blue-500 to-indigo-700', count: `${providerStats.total || stats.providers} listings` },
    { id: 'categories', icon: Layers, title: 'Category Management', desc: 'Add, edit or organize services & subcategories', color: 'from-emerald-500 to-teal-700', count: `${categories.length || stats.categories} categories` },
    { id: 'locations', icon: Map, title: 'Location Management', desc: 'Manage covered States, Districts, Cities & Areas', color: 'from-purple-500 to-fuchsia-700', count: 'All India coverage' },
    { id: 'analytics', icon: TrendingUp, title: 'Analytics & Reports', desc: 'Platform insights, growth metrics, category breakdowns', color: 'from-amber-500 to-orange-700', count: 'Live Analytics' },
    { id: 'users', icon: ShieldCheck, title: 'Role & Permissions', desc: 'Manage user access, promote State/District Managers', color: 'from-slate-700 to-slate-900', count: `${stats.customers || 0} users` },
    { id: 'settings', icon: Settings, title: 'CMS & Settings', desc: 'Emergency banners, helpline, SEO and platform toggles', color: 'from-rose-500 to-pink-700', count: 'Platform Config' },
    { id: 'payment-gateway', icon: CreditCard, title: 'Payment Gateway', desc: 'Connect Razorpay for Premium plan checkout & view billing', color: 'from-violet-600 to-indigo-800', count: gateway.enabled ? 'Connected' : 'Not configured' },
  ];
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans">
        ...
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Link href="/" className="flex items-center gap-2.5">
              <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-blue-600 via-indigo-500 to-orange-500 grid place-items-center text-white font-black text-sm shadow-md shadow-blue-500/20">
                S2
              </div>
            ...
            <Badge variant="outline" className="ml-2 bg-blue-950/60 text-blue-400 border-blue-800 text-[11px] px-2.5 py-0.5">
              {user.role.replace('_', ' ').toUpperCase()}
            </Badge>
          </div>

          <div className="flex items-center gap-3">
            <Link href="/" target="_blank" className="text-xs text-slate-400 hover:text-white transition flex items-center gap-1">
      ...
      <div className="container mx-auto px-4 py-6 max-w-7xl">
        {/* Navigation Tabs Bar */}
        <div className="flex items-center justify-between gap-2 overflow-x-auto pb-3 mb-6 border-b border-slate-800 scrollbar-none">
        ...
        {activeTab === 'overview' && (
          <div className="space-y-8 animate-fadeIn">
            {/* Header Banner */}
            <div className="bg-gradient-to-r from-blue-950/60 via-indigo-950/40 to-slate-900 border border-blue-900/40 rounded-2xl p-6 relative overflow-hidden shadow-xl">
              <div className="relative z-10 max-w-2xl">
                <Badge className="bg-blue-500/20 text-blue-300 border-blue-500/30 mb-2">Platform Control Room</Badge>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              {overviewTiles.map((t) => (
                <Card
                  ...
                  className="bg-slate-900/80 border-slate-800 hover:border-slate-700 transition cursor-pointer hover:shadow-lg"
                >
              ...
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h2 className="text-xl font-bold text-white flex items-center gap-2">
                    <SlidersHorizontal className="w-5 h-5 text-blue-400" /> Platform Management Modules
                  </h2>
                  <p className="text-xs text-slate-400 mt-0.5">Click any module below to open its full control panel</p>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
                {mgmtModules.map((m) => (
                  <Card
                    ...
                    className="bg-slate-900/90 border-slate-800 hover:border-blue-500/50 hover:bg-slate-900 transition-all cursor-pointer group shadow-md hover:shadow-blue-500/10"
                  >
                    <CardContent className="p-5">
                      <div className="flex items-start justify-between">
                        ...
                        <span className="text-[11px] font-medium bg-slate-800 text-slate-300 px-2.5 py-0.5 rounded-full">
                          {m.count}
                        </span>
                      </div>
                      <div className="font-bold text-white text-base group-hover:text-blue-400 transition flex items-center justify-between">
                        {m.title}
                        <ChevronRight className="w-4 h-4 text-slate-500 group-hover:translate-x-1 transition" />
                      </div>
                      <div className="text-xs text-slate-400 mt-1.5 leading-relaxed">{m.desc}</div>
                    </CardContent>
                  </Card>
                ))}
              </div>
          ...
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div>
                <h1 className="text-2xl font-bold text-white flex items-center gap-2">
                  <Building2 className="w-6 h-6 text-blue-400" /> Provider Management
                </h1>
              ...
              <div className="flex items-center gap-2">
                <Button onClick={() => setIsAddGovtServiceOpen(true)} variant="outline" className="bg-orange-950/40 hover:bg-orange-900/50 border-orange-800/60 text-orange-300 text-xs gap-1.5">
                  <Landmark className="w-4 h-4" /> Add Government Service
                </Button>
                <Button onClick={() => setIsAddProviderOpen(true)} className="bg-blue-600 hover:bg-blue-500 text-white text-xs gap-1.5 shadow-md shadow-blue-600/30">
            ...
            <Card className="bg-slate-900 border-slate-800">
              <CardContent className="p-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
                  ...
                  {/* Refresh Button */}
                  <Button variant="outline" size="sm" onClick={fetchProviders} className="bg-slate-950 border-slate-800 text-slate-300 text-xs gap-1">
            ...
            {loadingProviders ? (
              ...
              <div className="bg-slate-900 border border-slate-800 rounded-xl p-12 text-center text-slate-500">
                ...
                <div className="text-base font-semibold text-slate-400">No Providers Found</div>
                <p className="text-xs text-slate-600 mt-1">Try clearing search filters or add a new provider.</p>
              </div>
            ) : (
                        ...
                        <tr key={p.id} className="hover:bg-slate-800/40 transition">
                          ...
                          <td className="py-3 px-4">
                            ...
                            <div className="text-slate-400 text-[11px] flex items-center gap-2 mt-0.5">
                              {p.phone && <span className="flex items-center gap-0.5"><Phone className="w-3 h-3 text-slate-500" /> {p.phone}</span>}
                          ...
                          {/* Category */}
                          <td className="py-3 px-4">
                            <Badge variant="outline" className="bg-blue-950/40 border-blue-800 text-blue-300 text-[11px]">
                          ...
                          <td className="py-3 px-4 text-center">
                            <button
                              ...
                              className={`p-1.5 rounded-lg border transition ${
                                p.verified
                                  ? 'bg-blue-950/80 text-blue-400 border-blue-700 hover:bg-blue-900'
                          ...
                          <td className="py-3 px-4 text-right">
                            <div className="flex items-center justify-end gap-1.5">
                              ...
                              <Button
                                ...
                                className="bg-slate-950 border-slate-800 text-slate-300 hover:text-white h-7 px-2 text-[11px]"
                              >
          ...
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {categories
                ...
                .map((cat) => (
                  <Card key={cat.id || cat.slug} className="bg-slate-900 border-slate-800 hover:border-slate-700 transition shadow-md">
                    <CardContent className="p-4">
                      ...
                      <div className="text-xs text-slate-500 mt-0.5">slug: <code className="text-blue-400">/{cat.slug}</code></div>
                      {cat.description && <div className="text-xs text-slate-400 mt-2 line-clamp-2">{cat.description}</div>}
                      ...
                      <div className="flex items-center justify-end gap-2 mt-4 pt-3 border-t border-slate-800/80">
                        <Button
                          ...
                          className="bg-slate-950 border-slate-800 text-slate-300 hover:text-white h-7 px-2 text-[11px] gap-1"
                        >
        ...
        {activeTab === 'locations' && (
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div>
                <h1 className="text-2xl font-bold text-white flex items-center gap-2">
                  <Map className="w-6 h-6 text-purple-400" /> Location & Coverage Management
                </h1>
                <p className="text-xs text-slate-400 mt-1">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              <Card className="bg-slate-900/90 border-slate-800">
                <CardContent className="p-4 flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-purple-500/10 border border-purple-500/30 grid place-items-center text-purple-400">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-slate-400">Active Covered States</div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-slate-900/90 border-slate-800">
                <CardContent className="p-4 flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-blue-500/10 border border-blue-500/30 grid place-items-center text-blue-400">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-slate-400">Covered Cities & Towns</div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-slate-900/90 border-slate-800">
                <CardContent className="p-4 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-slate-400">Registered Localities & Hubs</div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-slate-900/90 border-slate-800">
                <CardContent className="p-4 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-slate-400">Custom Admin Added</div>
                  </div>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-3">
              <div className="text-xs font-semibold text-slate-300 mb-2 flex items-center justify-between">
                ...
                <span className="text-[11px] text-slate-400">{locationsList.length} locations shown</span>
              </div>
            ...
            {loadingLocations ? (
              <div className="p-12 text-center text-slate-400 bg-slate-900 rounded-xl border border-slate-800 flex flex-col items-center justify-center">
                <RefreshCw className="w-6 h-6 animate-spin text-purple-500 mb-2" />
                <span>Loading location dataset...</span>
              </div>
            ) : locationsList.length === 0 ? (
              <div className="p-12 text-center bg-slate-900/70 border border-slate-800 rounded-2xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {locationsList.map((loc, idx) => (
                  <div
                    key={loc.id || idx}
                    className="bg-slate-900/90 border border-slate-800 hover:border-slate-700 rounded-2xl p-4 flex flex-col justify-between shadow-xl transition space-y-3"
                  >
                    {/* Header */}
                    <div>
                      <div className="flex items-start justify-between gap-2 mb-2">
                        <div>
                          <span className="text-[10px] uppercase tracking-wider font-bold text-purple-400 bg-purple-950/60 px-2 py-0.5 rounded border border-purple-800">
                            {loc.state}
                          </span>
                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          <Badge className="bg-blue-950 text-blue-300 border-blue-800 text-[10px] py-0">
                            {loc.tier || 'Tier 2'}
                          </Badge>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Badge className="bg-slate-950 text-slate-300 border-slate-800 text-[11px]">
                      ...
                      {loc.pincode && (
                        <div className="text-[11px] text-slate-400 mt-1">
                          Postal Code: <span className="text-slate-300 font-mono">{loc.pincode}</span>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="space-y-2 pt-2 border-t border-slate-800/80">
                      ...
                      <div className="flex flex-wrap gap-1 max-h-28 overflow-y-auto pr-1">
                        {(loc.areas || []).map((area, aIdx) => (
                          <span
                            key={aIdx}
                            className="inline-flex items-center gap-1 text-[10px] bg-slate-950 text-slate-300 px-2 py-0.5 rounded border border-slate-800 group hover:border-red-900"
                          >
                            <span>{area}</span>
                            <button
                              type="button"
                              onClick={() => handleDeleteArea(loc.id, area)}
                              className="text-slate-500 hover:text-red-400 text-xs font-bold leading-none"
                              title={`Remove ${area}`}
                            >
                              ×
                            </button>
                      ...
                      >
                        <Input
                          ...
                          className="h-7 bg-slate-950 border-slate-800 text-[11px] text-white placeholder:text-slate-600 px-2"
                        />
                        <Button
                          type="submit"
                          size="sm"
                          variant="outline"
                          className="h-7 px-2 bg-slate-950 border-slate-800 hover:bg-slate-800 text-purple-400 text-xs shrink-0"
                        >
                    ...
                    <div className="flex items-center justify-end gap-1.5 pt-2 border-t border-slate-800/80">
                      <Button
                        ...
                        className="h-7 px-2 bg-slate-950 border-slate-800 hover:bg-slate-800 text-blue-400 text-[11px] gap-1"
                      >
                        <Edit className="w-3 h-3" /> Edit
                      </Button>
                      <Button
            ...
            {analyticsData && (
              <>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <Card className="bg-slate-900 border-slate-800">
                    <CardContent className="p-4">
                      <div className="text-xs text-slate-400">Total User Accounts</div>
                  ...
                  <Card className="bg-slate-900 border-slate-800">
                    <CardContent className="p-4">
                      <div className="text-xs text-slate-400">Total Bookings Processed</div>
                      <div className="text-2xl font-bold text-blue-400 mt-1">{analyticsData.overview?.totalBookings}</div>
                      <div className="text-[11px] text-slate-500 mt-1">
                  ...
                  <Card className="bg-slate-900 border-slate-800">
                    <CardContent className="p-4">
                      ...
                      <div className="text-[11px] text-slate-500 mt-1">4.7 Avg Platform Rating</div>
                    </CardContent>
                  </Card>
                </div>
                    ...
                    {(analyticsData.categoryStats || []).map((c, idx) => (
                      <div key={idx} className="space-y-1">
                        <div className="flex justify-between text-xs font-semibold">
                          <span className="text-slate-200">{c.name} ({c.group})</span>
                          <span className="text-blue-400">{c.providerCount} listings</span>
                        </div>
        ...
        {activeTab === 'users' && (
          <div className="space-y-6 animate-fadeIn">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div>
                <h1 className="text-2xl font-bold text-white flex items-center gap-2">
                  <ShieldCheck className="w-6 h-6 text-indigo-400" /> Users & Permissions Management
                </h1>
                <p className="text-xs text-slate-400 mt-1">
            ...
            <Card className="bg-slate-900 border-slate-800">
              <CardContent className="p-4">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  ...
                  <Button variant="outline" size="sm" onClick={fetchUsers} className="bg-slate-950 border-slate-800 text-slate-300 text-xs gap-1">
                      ...
                      <tr key={u.id} className="hover:bg-slate-800/40 transition">
                        ...
                        <td className="py-3 px-4">
                          <select
                            ...
                            className="bg-slate-950 border border-slate-800 rounded px-2 py-1 text-xs text-blue-400 font-semibold"
                          >
                            <option value="customer">Customer</option>
                            <option value="provider">Provider</option>
                            <option value="state_manager">State Manager</option>
        ...
        {activeTab === 'bookings' && (
          <div className="space-y-6 animate-fadeIn">
            <div>
              <h1 className="text-2xl font-bold text-white flex items-center gap-2">
                <Calendar className="w-6 h-6 text-purple-400" /> Bookings & Appointments Moderation
              </h1>
              <p className="text-xs text-slate-400 mt-1">
              ...
              <CardContent className="p-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <Input
                    ...
                    className="bg-slate-950 border-slate-800 text-xs text-white placeholder:text-slate-600"
                  />
                  <select
                  ...
                  <tbody className="divide-y divide-slate-800/60">
                    {bookingsList.map((b) => (
                      <tr key={b.id} className="hover:bg-slate-800/40 transition">
                        ...
                        <td className="py-3 px-4 text-blue-400 font-medium">{b.serviceName}</td>
                        <td className="py-3 px-4 text-slate-300">{b.bookingDate} · {b.timeSlot}</td>
                        <td className="py-3 px-4">
                          <Badge className={`text-[10px] uppercase font-bold ${
                            b.status === 'completed'
                              ? 'bg-emerald-950 text-emerald-400 border-emerald-800'
        ...
        {activeTab === 'settings' && (
          <div className="space-y-6 max-w-3xl animate-fadeIn">
            <div>
              <h1 className="text-2xl font-bold text-white flex items-center gap-2">
                <Settings className="w-6 h-6 text-rose-400" /> Platform CMS & System Settings
              </h1>
              <p className="text-xs text-slate-400 mt-1">
            ...
            <form onSubmit={handleSaveSettings} className="space-y-5 bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl">
              <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-semibold text-slate-300 mb-1.5">Support Phone / Helpline</label>
                  <Input
              ...
              <div>
                <label className="block text-xs font-semibold text-slate-300 mb-1.5">Emergency & Notification Banner Text</label>
                <Input
              ...
              <div className="flex items-center gap-3 pt-2">
                ...
                />
                <label htmlFor="noticeActive" className="text-xs text-slate-300 cursor-pointer">
              ...
              <div className="pt-4 border-t border-slate-800">
                <Button type="submit" disabled={savingSettings} className="bg-blue-600 hover:bg-blue-500 text-white text-xs gap-1.5">
        ...
        {activeTab === 'payment-gateway' && (
          <div className="space-y-6 max-w-3xl animate-fadeIn">
            <div>
              <h1 className="text-2xl font-bold text-white flex items-center gap-2">
                <CreditCard className="w-6 h-6 text-violet-400" /> Payment Gateway & Billing
              </h1>
              <p className="text-xs text-slate-400 mt-1">
            ...
            <form onSubmit={handleSaveGateway} className="space-y-5 bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl">
              <div className="flex items-center justify-between">
                <h3 className="font-bold text-white flex items-center gap-2"><KeyRound className="w-4 h-4 text-violet-400" /> Razorpay Configuration</h3>
                <Badge className={gateway.enabled ? 'bg-emerald-950/60 text-emerald-300 border-emerald-800' : 'bg-slate-800 text-slate-400 border-slate-700'} variant="outline">
                  {gateway.enabled ? 'Live' : 'Disabled'}
                </Badge>
              </div>

              <div>
                <label className="block text-xs font-semibold text-slate-300 mb-1.5">Razorpay Key ID</label>
                <Input
                  value={gateway.keyId}
              ...
              <div>
                <label className="block text-xs font-semibold text-slate-300 mb-1.5">Razorpay Key Secret</label>
                <Input
                  type="password"
                  ...
                  className="bg-slate-950 border-slate-800 text-xs text-white font-mono"
                />
                <p className="text-[11px] text-slate-500 mt-1">Stored server-side only, never shown back in full.</p>
              </div>

              <div>
                <label className="block text-xs font-semibold text-slate-300 mb-1.5">Premium Plan Price (₹ / month)</label>
                <Input
                  type="number"
                  value={gateway.premiumAmount}
                  onChange={(e) => setGateway({ ...gateway, premiumAmount: parseInt(e.target.value) || 0 })}
                  className="bg-slate-950 border-slate-800 text-xs text-white max-w-[160px]"
                />
              </div>
              ...
              <div className="flex items-center gap-3 pt-2">
                <input
                  ...
                  className="w-4 h-4 rounded bg-slate-950 border-slate-800 text-violet-600 focus:ring-0"
                />
                <label htmlFor="gatewayEnabled" className="text-xs text-slate-300 cursor-pointer">
                  Enable live checkout — when off, providers get Premium instantly in demo mode (no charge)
                </label>
              </div>

              <div className="pt-4 border-t border-slate-800">
                <Button type="submit" disabled={savingGateway} className="bg-violet-600 hover:bg-violet-500 text-white text-xs gap-1.5">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <Card className="bg-slate-900 border-slate-800">
                <CardContent className="p-4">
                  <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-blue-500 to-indigo-700 grid place-items-center text-white mb-2"><Wallet className="w-4 h-4" /></div>
                  <div className="text-xl font-bold text-white">{billingStats.paidTransactions || 0}</div>
                  <div className="text-xs text-slate-400">Paid Transactions</div>
                </CardContent>
              </Card>
              <Card className="bg-slate-900 border-slate-800">
                <CardContent className="p-4">
                  ...
                  <div className="text-xs text-slate-400">Active Premium Providers</div>
                </CardContent>
              </Card>
            </div>
            ...
            <Card className="bg-slate-900 border-slate-800">
              <CardContent className="p-5">
                <h3 className="font-bold text-white mb-3 flex items-center gap-2"><CreditCard className="w-4 h-4 text-violet-400" /> Recent Checkout Transactions</h3>
                {loadingBilling ? (
                  <div className="text-xs text-slate-400 py-6 text-center">Loading transactions...</div>
                ) : billingList.length === 0 ? (
                  <div className="text-xs text-slate-400 py-6 text-center">No billing transactions yet.</div>
                ) : (
                  <div className="space-y-2">
                    {billingList.map(t => (
                      <div key={t.id} className="flex items-center justify-between px-3 py-2.5 rounded-lg bg-slate-950 border border-slate-800">
                        <div>
                          <div className="text-sm font-semibold text-white">{t.ownerName || 'Provider'}</div>
                          <div className="text-[11px] text-slate-500">{t.razorpayOrderId} {t.createdAt ? `• ${new Date(t.createdAt).toLocaleString('en-IN')}` : ''}</div>
                        </div>
                        <div className="flex items-center gap-3">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              <Card className="bg-slate-900/90 border-slate-800">
                <CardContent className="p-4 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-slate-400">Total Ad Campaigns</div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-slate-900/90 border-slate-800">
                <CardContent className="p-4 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-slate-400">Live Running Ads</div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-slate-900/90 border-slate-800">
                <CardContent className="p-4 flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-2xl font-bold text-purple-400">{(adsStats.totalImpressions || 0).toLocaleString()}</div>
                    <div className="text-xs text-slate-400">Total Ad Views (Impressions)</div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-slate-900/90 border-slate-800">
                <CardContent className="p-4 flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-2xl font-bold text-amber-400">
                      {(adsStats.totalClicks || 0).toLocaleString()} <span className="text-xs font-normal text-slate-400">({adsStats.averageCTR || 0}% CTR)</span>
                    </div>
                    <div className="text-xs text-slate-400">Total Clicks & Conversion</div>
                  </div>
                </CardContent>
              </Card>
            </div>
              ...
              <div className="flex flex-wrap gap-2">
                {AD_PRESETS.map((preset, idx) => (
                  <button
                    ...
                    className="text-xs px-3 py-1.5 rounded-lg bg-slate-800/90 hover:bg-slate-700 border border-slate-700/80 text-slate-200 hover:text-white transition flex items-center gap-1.5 group"
                  >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {adsList.map((ad, idx) => {
                  ...
                  return (
                    <div
                      key={ad.id || idx}
                      className={`rounded-2xl border overflow-hidden transition-all bg-slate-900/90 shadow-xl flex flex-col ${
                        isLive ? 'border-slate-800 hover:border-amber-500/50' : 'border-slate-800/60 opacity-75'
                      }`}
                    >
                      {/* Banner Mockup Header */}
                      <div className="relative h-48 sm:h-52 w-full overflow-hidden bg-slate-950 flex flex-col justify-end p-4 sm:p-5">
                        {ad.imageUrl ? (
                          <div
                          ...
                          <div className="absolute inset-0 bg-slate-900 grid place-items-center text-slate-700">
                            <ImageIcon className="w-12 h-12" />
                          </div>
                        )}
                        
                        <div className={`absolute inset-0 bg-gradient-to-br ${ad.gradient || 'from-blue-950/90 via-blue-900/85 to-orange-800/80'}`} />
                        ...
                        <div className="relative z-10 flex items-center justify-between gap-2 mb-auto flex-wrap">
                          <div className="flex items-center gap-2">
                            ...
                            {isLive ? (
                              ...
                              <Badge className="bg-slate-800 text-slate-400 border-slate-700 text-[10px] py-0 capitalize">
                                {ad.status || 'Inactive'}
                              </Badge>
                            )}
                          ...
                          <div className="flex items-center gap-1 bg-black/50 backdrop-blur-md p-1 rounded-lg border border-white/10">
                            <button
                              ...
                              className="p-1 rounded hover:bg-white/20 text-slate-300 disabled:opacity-30 disabled:hover:bg-transparent"
                        ...
                        <div className="relative z-10 text-white space-y-1">
                          ...
                          {ad.subtitle && (
                            <p className="text-xs text-blue-100/90 line-clamp-1 max-w-md">
                              {ad.subtitle}
                            </p>
                          )}
                        </div>
                      ...
                      <div className="p-4 flex-1 flex flex-col justify-between space-y-3 bg-slate-900 border-t border-slate-800">
                        {/* Live Metrics Row */}
                        ...
                        <div className="pt-2 border-t border-slate-800/80 flex items-center justify-between gap-2">
                          ...
                          >
                            {isLive ? <ToggleRight className="w-4 h-4 text-emerald-400" /> : <ToggleLeft className="w-4 h-4 text-slate-400" />}
                          ...
                          <div className="flex items-center gap-1.5">
                            <Button
                              ...
                              className="h-8 px-2.5 bg-slate-950 border-slate-800 hover:bg-slate-800 text-slate-300 text-xs"
                            ...
                            <Button
                              ...
                              className="h-8 px-2.5 bg-slate-950 border-slate-800 hover:bg-slate-800 text-blue-400 text-xs gap-1"
                            >
        ...
        {activeTab === 'hero-slider' && (
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2">
                <Button
                  ...
                  className="bg-gradient-to-r from-blue-600 to-orange-500 hover:opacity-95 text-white text-xs gap-1.5 shadow-lg shadow-blue-500/20"
                >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <Card className="bg-slate-900/90 border-slate-800">
                <CardContent className="p-4 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-slate-400">Total Hero Slides</div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-slate-900/90 border-slate-800">
                <CardContent className="p-4 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-slate-400">Active (Live on Homepage)</div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-slate-900/90 border-slate-800">
                <CardContent className="p-4 flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-slate-800/80 border border-slate-700 grid place-items-center text-slate-400">
                    <XCircle className="w-5 h-5" />
                  </div>
                  <div>
                    <div className="text-2xl font-bold text-slate-400">{heroSlides.filter(s => !s.isActive).length}</div>
                    <div className="text-xs text-slate-400">Drafts / Inactive</div>
                  </div>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-4">
              <div className="text-xs font-semibold text-slate-300 mb-2 flex items-center gap-1.5">
                <Sparkles className="w-3.5 h-3.5 text-orange-400" /> Quick-Start Slide Presets (Click to create a curated banner):
              </div>
              <div className="flex flex-wrap gap-2">
                {PRESET_IMAGES.map((preset, idx) => (
                  ...
                  >
                    <span>{preset.label}</span>
                    <Plus className="w-3 h-3 text-blue-400 group-hover:scale-125 transition" />
                  </button>
                ))}
              </div>
            </div>
            ...
            {loadingSlides ? (
              ...
              <div className="p-12 text-center bg-slate-900/70 border border-slate-800 rounded-2xl">
                ...
                <Button onClick={() => setIsAddSlideOpen(true)} className="bg-blue-600 hover:bg-blue-500 text-white text-xs">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {heroSlides.map((slide, idx) => (
                  <div
                    key={slide.id || idx}
                    className={`rounded-2xl border overflow-hidden transition-all bg-slate-900/90 shadow-xl flex flex-col ${
                      slide.isActive ? 'border-slate-800 hover:border-blue-500/50' : 'border-slate-800/60 opacity-75'
                    }`}
                  >
                    {/* Visual Slide Mockup Header */}
                    <div className="relative h-48 sm:h-56 w-full overflow-hidden bg-slate-950 flex flex-col justify-end p-4 sm:p-5">
                      {/* Background Image */}
                      {slide.imageUrl ? (
                        <div
                          className="absolute inset-0 bg-cover bg-center transition-transform duration-500 hover:scale-105"
                      ...
                      <div className="relative z-10 flex items-center justify-between gap-2 mb-auto">
                        <div className="flex items-center gap-2">
                          ...
                          {slide.isActive ? (
                            ...
                            <Badge className="bg-slate-800 text-slate-400 border-slate-700 text-[10px] py-0">
                              Inactive
                            </Badge>
                          )}
                        </div>
                      ...
                      <div className="relative z-10 text-white space-y-1">
                        ...
                        {slide.subtitle && (
                          <p className="text-xs text-blue-100/80 line-clamp-1 max-w-md">
                            {slide.subtitle}
                          </p>
                        )}
                      </div>
                    ...
                    <div className="p-4 flex-1 flex flex-col justify-between space-y-3 bg-slate-900">
                      <div className="flex flex-wrap items-center justify-between text-xs text-slate-400 gap-2">
                        {slide.ctaText ? (
                          ...
                          <span className="text-slate-500 italic">No custom CTA button</span>
                        )}
                        <span className="text-[11px] text-slate-500">Order: {slide.order || idx + 1}</span>
                      </div>
                      ...
                      <div className="flex items-center justify-between gap-2 pt-3 border-t border-slate-800/80">
                        ...
                        >
                          {slide.isActive ? (
                            ...
                            <>
                              <ToggleLeft className="w-4 h-4 mr-1.5 text-slate-500" /> Inactive
                            </>
                          )}
                        </Button>
                        ...
                        <div className="flex items-center gap-1.5">
                          <Button
                            ...
                            className="bg-slate-950 border-slate-700 text-slate-200 hover:text-white text-xs h-8 px-3"
                          >
      ...
      <Dialog open={isAddProviderOpen} onOpenChange={setIsAddProviderOpen}>
        <DialogContent className="bg-slate-900 border-slate-800 text-white max-w-lg">
          ...
          <form onSubmit={handleCreateProvider} className="space-y-3.5 my-2">
            <div>
              <label className="block text-xs text-slate-300 mb-1">Business / Doctor / Provider Name *</label>
              <Input
                required
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                <label className="block text-xs text-slate-300 mb-1">Pricing Starts At</label>
                <Input
            ...
            <DialogFooter className="pt-3 border-t border-slate-800">
              <Button type="button" variant="outline" onClick={() => setIsAddProviderOpen(false)} className="bg-slate-950 border-slate-800 text-slate-300 text-xs">
                Cancel
              </Button>
        ...
        <DialogContent className="bg-slate-900 border-slate-800 text-white max-w-lg max-h-[85vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="text-lg font-bold flex items-center gap-2">
              <Landmark className="w-5 h-5 text-orange-400" /> Add Government Service
            </DialogTitle>
            <DialogDescription className="text-xs text-slate-400">
          ...
          <form onSubmit={handleCreateGovtService} className="space-y-3.5 my-2">
            <div>
              <label className="block text-xs text-slate-300 mb-1">Service / Center Name *</label>
              <Input
                required
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                <label className="block text-xs text-slate-300">Service Type *</label>
                <button
                  type="button"
            ...
            <div>
              <label className="block text-xs text-slate-300 mb-1">Website Link</label>
              <Input
                type="url"
            ...
            <div>
              ...
              {newGovtService.banner && (
                <div className="mb-2 h-24 rounded-lg bg-cover bg-center border border-slate-800" style={{ backgroundImage: `url(${newGovtService.banner})` }} />
              )}
              <FileUploader
            ...
            <DialogFooter className="pt-3 border-t border-slate-800">
              <Button type="button" variant="outline" onClick={() => { setIsAddGovtServiceOpen(false); setIsCustomGovtType(false); }} className="bg-slate-950 border-slate-800 text-slate-300 text-xs">
                Cancel
              </Button>
              <Button type="submit" className="bg-orange-600 hover:bg-orange-500 text-white text-xs">
      ...
      <Dialog open={!!editingGovtService} onOpenChange={(open) => !open && setEditingGovtService(null)}>
        <DialogContent className="bg-slate-900 border-slate-800 text-white max-w-lg max-h-[85vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="text-lg font-bold flex items-center gap-2">
              <Landmark className="w-5 h-5 text-orange-400" /> Edit Government Service
            </DialogTitle>
            <DialogDescription className="text-xs text-slate-400">
          ...
          {editingGovtService && (
            <form onSubmit={handleSaveEditGovtService} className="space-y-3.5 my-2">
              ...
              <div>
                <label className="block text-xs text-slate-300 mb-1">Service Type *</label>
                <select
              ...
              <div>
                ...
                {editingGovtService.banner && (
                  <div className="mb-2 h-24 rounded-lg bg-cover bg-center border border-slate-800" style={{ backgroundImage: `url(${editingGovtService.banner})` }} />
                )}
                <FileUploader
                  context="govt-service"
                  ownerId={user.id}
              ...
              <DialogFooter className="pt-3 border-t border-slate-800">
                <Button type="button" variant="outline" onClick={() => setEditingGovtService(null)} className="bg-slate-950 border-slate-800 text-slate-300 text-xs">
                  Cancel
                </Button>
                <Button type="submit" className="bg-orange-600 hover:bg-orange-500 text-white text-xs">
                  Save Changes
          ...
          {editingProvider && (
            <form onSubmit={handleSaveEditProvider} className="space-y-3.5 my-2">
              {editingProvider.group === 'Government Services' && (
                <Badge className="bg-orange-950/50 text-orange-300 border-orange-800/60 gap-1.5">
                  <Landmark className="w-3 h-3" /> Government Service Listing
                </Badge>
              )}

              <div>
                <label className="block text-xs text-slate-300 mb-1">Business / Service Name</label>
                <Input
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label className="block text-xs text-slate-300 mb-1">Fee / Price Starts At</label>
                  <Input
              ...
              <div>
                <label className="block text-xs text-slate-300 mb-1">Photo / Logo</label>
                {editingProvider.banner && (
                  <div className="mb-2 h-24 rounded-lg bg-cover bg-center border border-slate-800" style={{ backgroundImage: `url(${editingProvider.banner})` }} />
                )}
                <FileUploader
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label className="block text-xs text-slate-300 mb-1">Verified</label>
                  <button
                    type="button"
                    onClick={() => setEditingProvider({ ...editingProvider, verified: !editingProvider.verified })}
                    className={`w-full flex items-center justify-center gap-1.5 rounded-md px-3 py-2 text-xs border ${editingProvider.verified ? 'bg-emerald-950/50 border-emerald-800 text-emerald-300' : 'bg-slate-950 border-slate-800 text-slate-400'}`}
                  >
              ...
              <DialogFooter className="pt-3 border-t border-slate-800">
                <Button type="button" variant="outline" onClick={() => setEditingProvider(null)} className="bg-slate-950 border-slate-800 text-slate-300 text-xs">
                  Cancel
                </Button>
                <Button type="submit" className="bg-blue-600 hover:bg-blue-500 text-white text-xs">
                  Save Changes
      ...
      <Dialog open={isAddCategoryOpen} onOpenChange={setIsAddCategoryOpen}>
        <DialogContent className="bg-slate-900 border-slate-800 text-white max-w-md">
          ...
          <form onSubmit={handleCreateCategory} className="space-y-3.5 my-2">
            ...
            <div>
              <label className="block text-xs text-slate-300 mb-1">Service Group *</label>
              <select
            ...
            <DialogFooter className="pt-3 border-t border-slate-800">
              <Button type="button" variant="outline" onClick={() => setIsAddCategoryOpen(false)} className="bg-slate-950 border-slate-800 text-slate-300 text-xs">
                Cancel
              </Button>
        ...
        <DialogContent className="bg-slate-900 border-slate-800 text-white max-w-md">
          ...
          {editingCategory && (
            <form onSubmit={handleSaveEditCategory} className="space-y-3.5 my-2">
              ...
              <DialogFooter className="pt-3 border-t border-slate-800">
                <Button type="button" variant="outline" onClick={() => setEditingCategory(null)} className="bg-slate-950 border-slate-800 text-slate-300 text-xs">
                  Cancel
                </Button>
                <Button type="submit" className="bg-emerald-600 hover:bg-emerald-500 text-white text-xs">
                  Save Changes
      ...
      <Dialog open={isAddSlideOpen} onOpenChange={setIsAddSlideOpen}>
        <DialogContent className="bg-slate-900 border-slate-800 text-white max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <form onSubmit={handleCreateSlide} className="space-y-4 my-2">
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-300 mb-1.5">Live Banner Preview</label>
              <div className="relative h-44 w-full rounded-xl overflow-hidden border border-slate-700 bg-slate-950 flex flex-col justify-end p-4 shadow-inner">
                {newSlide.imageUrl && (
                  <div
                ...
                <div className={`absolute inset-0 bg-gradient-to-br ${newSlide.overlayGradient || 'from-blue-950/90 via-blue-900/85 to-orange-800/80'}`} />
                <div className="relative z-10 text-white space-y-1">
                  {newSlide.badge && (
                  ...
                  {newSlide.subtitle && (
                    <p className="text-[11px] text-blue-100/90 line-clamp-1">{newSlide.subtitle}</p>
                  )}
                  {newSlide.ctaText && (
                    <div className="pt-1">
                      <span className="inline-flex items-center text-[10px] bg-gradient-to-r from-blue-600 to-orange-500 text-white px-2.5 py-1 rounded-md font-semibold">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                <label className="block text-xs text-slate-300 mb-1">Badge / Tag Text</label>
                <Input
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                <label className="block text-xs text-slate-300 mb-1">Main Heading (White text) *</label>
                <Input
                  required
              ...
              <div>
                <label className="block text-xs text-slate-300 mb-1">Highlight Text (Gradient gold)</label>
                <Input
            ...
            <div>
              <label className="block text-xs text-slate-300 mb-1">Subtitle / Description</label>
              <Input
            ...
            {/* Image URL & Uploader */}
            <div className="space-y-2">
              <label className="block text-xs font-semibold text-slate-300">Background Image URL</label>
              <Input
                required
              ...
              <div className="flex flex-wrap gap-1.5">
                {PRESET_IMAGES.map((preset, i) => (
                  <button
                    ...
                    className="text-[10px] px-2 py-1 rounded bg-slate-950 hover:bg-slate-800 border border-slate-800 text-slate-300 transition"
                  >
                    {preset.label}
                  </button>
                ))}
              ...
              {/* Upload local image */}
              <div className="pt-2">
                <div className="text-[11px] text-slate-400 mb-1">Or upload image from your computer:</div>
                <FileUploader
                  context="hero-slide"
                  ownerId={user.id}
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-300 mb-1.5">Color Overlay Gradient</label>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                <label className="block text-xs text-slate-300 mb-1">CTA Button Text (Optional)</label>
                <Input
              ...
              <div>
                <label className="block text-xs text-slate-300 mb-1">CTA Link Destination (Optional)</label>
                <Input
            ...
            <div className="flex items-center gap-3 pt-2">
              <input
                ...
                className="w-4 h-4 rounded bg-slate-950 border-slate-800 text-blue-600 focus:ring-0"
              />
              <label htmlFor="slideActiveNew" className="text-xs text-slate-300 cursor-pointer">
      ...
      <Dialog open={!!editingSlide} onOpenChange={(open) => !open && setEditingSlide(null)}>
        <DialogContent className="bg-slate-900 border-slate-800 text-white max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="text-lg font-bold flex items-center gap-2">
              <Edit className="w-5 h-5 text-blue-400" /> Edit Hero Banner Slide
            </DialogTitle>
            <DialogDescription className="text-xs text-slate-400">
            ...
            <form onSubmit={handleSaveEditSlide} className="space-y-4 my-2">
              ...
              <div>
                ...
                <div className="relative h-44 w-full rounded-xl overflow-hidden border border-slate-700 bg-slate-950 flex flex-col justify-end p-4 shadow-inner">
                  ...
                  <div className={`absolute inset-0 bg-gradient-to-br ${editingSlide.overlayGradient || 'from-blue-950/90 via-blue-900/85 to-orange-800/80'}`} />
                  <div className="relative z-10 text-white space-y-1">
                    {editingSlide.badge && (
                      <span className="inline-block bg-white/20 backdrop-blur-md border border-white/30 text-white text-[10px] px-2 py-0.5 rounded-full font-medium">
                        {editingSlide.badge}
                    ...
                    {editingSlide.subtitle && (
                      <p className="text-[11px] text-blue-100/90 line-clamp-1">{editingSlide.subtitle}</p>
                    )}
              ...
              <div className="space-y-2">
                ...
                {/* Upload local image */}
                <div className="pt-2">
                  <div className="text-[11px] text-slate-400 mb-1">Or upload a new image from your computer:</div>
                  <FileUploader
                    context="hero-slide"
                    ownerId={user.id}
              ...
              <div className="flex items-center gap-3 pt-2">
                <input
                  ...
                  className="w-4 h-4 rounded bg-slate-950 border-slate-800 text-blue-600 focus:ring-0"
                />
                <label htmlFor="slideActiveEdit" className="text-xs text-slate-300 cursor-pointer">
        ...
        <DialogContent className="bg-slate-900 border-slate-800 text-white max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <form onSubmit={handleCreateAd} className="space-y-4 my-2">
            ...
            <div>
              ...
              <div className="relative h-44 w-full rounded-2xl overflow-hidden border border-slate-700 bg-slate-950 flex flex-col justify-end p-4 shadow-2xl">
                {newAd.imageUrl && (
                  <div
                    className="absolute inset-0 bg-cover bg-center"
                ...
                <div className={`absolute inset-0 bg-gradient-to-br ${newAd.gradient || 'from-amber-600 via-orange-600 to-red-700'}`} />
                ...
                <div className="relative z-10 text-white space-y-1">
                  <div className="flex items-center gap-1.5 flex-wrap">
                    ...
                    {newAd.advertiserName && (
                      <span className="text-[10px] text-blue-100 bg-black/40 px-2 py-0.5 rounded">
                        by {newAd.advertiserName}
                      </span>
                    )}
                    <span className="text-[10px] bg-slate-950/80 text-amber-300 border border-amber-500/30 px-1.5 py-0.5 rounded">
                      {newAd.placement}
                    </span>
                  </div>
                  ...
                  {newAd.subtitle && (
                    <p className="text-[11px] text-blue-50/90 line-clamp-1">{newAd.subtitle}</p>
                  )}

                  <div className="pt-1 flex items-center gap-2">
                    <span className="inline-flex items-center text-[10px] bg-gradient-to-r from-orange-500 to-amber-400 text-slate-950 font-extrabold px-3 py-1 rounded-md shadow">
            ...
            {/* Campaign Title */}
            <div>
              <label className="block text-xs font-semibold text-slate-300 mb-1">Campaign Title / Offer Heading *</label>
              <Input
                required
                value={newAd.title}
            ...
            {/* Subtitle / Pitch */}
            <div>
              <label className="block text-xs text-slate-300 mb-1">Subtitle / Offer Description</label>
              <Input
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                <label className="block text-xs font-semibold text-slate-300 mb-1">Display Placement *</label>
                <select
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                <label className="block text-xs text-slate-300 mb-1">Advertiser / Sponsor Name</label>
                <Input
              ...
              <div>
                <label className="block text-xs text-slate-300 mb-1">Advertiser Phone / WhatsApp</label>
                <Input
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                <label className="block text-xs font-semibold text-slate-300 mb-1">Click Target URL / Link *</label>
                <Input
                  required
              ...
              <div>
                <label className="block text-xs text-slate-300 mb-1">CTA Button Text</label>
                <Input
                  value={newAd.ctaText}
            ...
            <div className="space-y-2">
              <label className="block text-xs font-semibold text-slate-300">Banner Background Image URL</label>
              <Input
              ...
              <div className="pt-2">
                <div className="text-[11px] text-slate-400 mb-1">Or upload an ad graphic from your device:</div>
                <FileUploader
                  context="ad-banner"
                  ownerId={user.id}
            ...
            {/* Color Overlay Gradient Selection */}
            <div>
              <label className="block text-xs font-semibold text-slate-300 mb-1.5">Banner Gradient Theme</label>
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                {GRADIENT_PRESETS.map((g, i) => (
                  <button
                    key={i}
                    type="button"
                    onClick={() => setNewAd({ ...newAd, gradient: g.value })}
                    className={`p-2 rounded-lg border text-left text-xs transition flex items-center gap-2 ${
                      newAd.gradient === g.value
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              <div>
                <label className="block text-xs text-slate-300 mb-1">End Date (Expiry)</label>
                <Input
                  type="date"
                  value={newAd.endDate || ''}
              ...
              <div>
                <label className="block text-xs text-slate-300 mb-1">Display Priority (1 = Top)</label>
                <Input
                  type="number"
                  min="1"
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              />
              <label htmlFor="adActiveNew" className="text-xs text-slate-300 cursor-pointer">
            ...
            <form onSubmit={handleSaveEditAd} className="space-y-4 my-2">
              ...
              <div>
                ...
                <div className="relative h-44 w-full rounded-2xl overflow-hidden border border-slate-700 bg-slate-950 flex flex-col justify-end p-4 shadow-2xl">
                  ...
                  <div className={`absolute inset-0 bg-gradient-to-br ${editingAd.gradient || 'from-amber-600 via-orange-600 to-red-700'}`} />
                  ...
                  <div className="relative z-10 text-white space-y-1">
                    ...
                    {editingAd.subtitle && (
                      <p className="text-[11px] text-blue-50/90 line-clamp-1">{editingAd.subtitle}</p>
                    )}
              ...
              <div className="space-y-2">
                ...
                <div className="pt-2">
                  <div className="text-[11px] text-slate-400 mb-1">Or upload new banner image:</div>
                  <FileUploader
                    context="ad-banner"
                    ownerId={user.id}
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                  {GRADIENT_PRESETS.map((g, i) => (
                    <button
                      key={i}
                      type="button"
                      onClick={() => setEditingAd({ ...editingAd, gradient: g.value })}
                      className={`p-2 rounded-lg border text-left text-xs transition flex items-center gap-2 ${
                        editingAd.gradient === g.value
                          ? 'border-amber-500 bg-amber-950/40 text-white shadow-sm'
                          : 'border-slate-800 bg-slate-950 text-slate-400 hover:text-slate-200'
                      }`}
                    >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                ...
                <div>
                  <label className="block text-xs text-slate-300 mb-1">Display Priority</label>
                  <Input
                    type="number"
                    min="1"
              ...
              {/* Status */}
              <div>
                <label className="block text-xs text-slate-300 mb-1">Campaign Status</label>
                <select
      ...
      <Dialog open={isAddLocationOpen} onOpenChange={setIsAddLocationOpen}>
        <DialogContent className="bg-slate-900 border-slate-800 text-white max-w-lg max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="text-lg font-bold flex items-center gap-2">
              <MapPin className="w-5 h-5 text-purple-400" /> Add New Location / City
            </DialogTitle>
            <DialogDescription className="text-xs text-slate-400">
          ...
          <form onSubmit={handleCreateLocation} className="space-y-4 my-2">
            {/* State Selection */}
            <div>
              <label className="block text-xs font-semibold text-slate-300 mb-1">State / Union Territory *</label>
              <select
            ...
            {newLocation.state === 'CUSTOM' && (
              <div>
                <label className="block text-xs font-semibold text-purple-300 mb-1">Custom State Name *</label>
                <Input
                  required
                  ...
                  className="bg-slate-950 border-purple-800/80 text-xs text-white"
                />
              </div>
            )}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                <label className="block text-xs font-semibold text-slate-300 mb-1">City / Town Name *</label>
                <Input
                  required
              ...
              <div>
                <label className="block text-xs text-slate-300 mb-1">District Name</label>
                <Input
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                <label className="block text-xs text-slate-300 mb-1">Postal / Pincode (Optional)</label>
                <Input
              ...
              <div>
                <label className="block text-xs text-slate-300 mb-1">Coverage Tier</label>
                <select
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              />
              <label htmlFor="locationActiveNew" className="text-xs text-slate-300 cursor-pointer">
      ...
      <Dialog open={!!editingLocation} onOpenChange={(open) => !open && setEditingLocation(null)}>
        <DialogContent className="bg-slate-900 border-slate-800 text-white max-w-lg max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="text-lg font-bold flex items-center gap-2">
              <Edit className="w-5 h-5 text-purple-400" /> Edit Location / City
            </DialogTitle>
            <DialogDescription className="text-xs text-slate-400">
          ...
          {editingLocation && (
            <form onSubmit={handleSaveEditLocation} className="space-y-4 my-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs text-slate-300 mb-1">Postal / Pincode</label>
                  <Input
              ...
              <div className="flex items-center gap-3 pt-2">
                <input
                  ...
                  className="w-4 h-4 rounded bg-slate-950 border-slate-800 text-purple-600 focus:ring-0"
                />
                <label htmlFor="locationActiveEdit" className="text-xs text-slate-300 cursor-pointer">
              ...
              <DialogFooter className="pt-3 border-t border-slate-800">
                ...
                <Button
                  type="submit"
                  className="bg-purple-600 hover:bg-purple-500 text-white text-xs gap-1.5 font-bold"
                >
                  <Save className="w-3.5 h-3.5" /> Save Changes
                </Button>
              </DialogFooter>
    ...
    <Suspense
      fallback={
        <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center text-white">
          ...
          <div className="text-slate-400 text-sm">Loading Search2Service Admin Console...</div>
        </div>
      }
    >
